...
export function EditCurrency({ currency, isOpen, onClose, onSuccess }: EditCurrencyProps) {
  ...
  const { form, handleSubmit, isPending } = useCurrencyForm("edit", currency ?? undefined, handleSuccess);
